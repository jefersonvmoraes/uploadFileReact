...
import { AiFillFileAdd, AiOutlineCloudUpload, AiOutlineLoading3Quarters } from "react-icons/ai";
  ...
  return (
    <div className="upload-area container">
      <div className="text-center mt-4">
        <h1>Upload Files <AiOutlineCloudUpload/></h1>
      </div>
      {
        loading && (
      ...
      <form className="form" onSubmit={onSubmit}>
        <div className="text-center mt-4 button-upload-area">
          <label className="btn btn-primary label-input-upload" htmlFor="input-upload">
            <span style={{fontSize: "18px", marginRight: "10px"}}>Selecionar arquivo</span>
                  ...
                  <ul key={index}>
                    <li >
                      <div className="view-file-item">
                        ...
                        <button onClick={removeFile} type="button" className="btn btn-outline-danger" value={item?.name}>
                          <CgTrash size={25}/>
                        </button>
